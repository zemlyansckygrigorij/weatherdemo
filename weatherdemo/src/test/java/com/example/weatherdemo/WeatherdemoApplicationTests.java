...
import com.example.weatherdemo.services.OpenWeatherService;
import com.example.weatherdemo.services.YandexWeatherService;
...
//public class WeatherdemoApplicationTest {
 class WeatherdemoApplicationTest {
/*
	@LocalServerPort
	private int port;
	...
	public void getWeatherTest(String url) {
		when(openWeatherService.gWeather()).thenReturn(openWeather);
